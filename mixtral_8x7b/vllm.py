...
def build_app(cli_args: Dict[str, str]) -> serve.Application:
    ...
    for i in range(tp):
        pg_resources.append({"CPU": 5, "GPU": 1})  # for the vLLM actors
...
# Use below to start the Serve app.
# serve run llm:build_app model="NousResearch/Meta-Llama-3-8B-Instruct" tensor-parallel-size=2

# multinode setup vllm - 
